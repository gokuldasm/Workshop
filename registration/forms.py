...
chocolate_widgets = {
    ...
    'description': forms.TextInput(attrs={'placeholder': _('Chocolate Discription'), 'required': True}),
    'manufacturer': forms.TextInput(attrs={'placeholder': _('Chocolate Manufacturer'), 'required': True}),
    'price': forms.TextInput(attrs={'placeholder': _('Chocolate Price'), 'required': True}),
